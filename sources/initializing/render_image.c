...
/*   Updated: 2024/10/10 11:51:31 by kbolon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_update_pixels_img(t_data *data, t_img *img, int x, int y)//set_frame_image_pixel(
{
...
void	ft_draw_image_in_window(t_data *data)//render_frame
{
	t_img	image;
	int		x;
	int		y;
...
void	ft_init_game(t_data *data)//render_images
{
...
int	ft_render(t_data *data)//render
{
